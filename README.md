...
Targeted therapies can greatly improve outcomes for some lung adenocarcinoma patients, but patients can only benefit if they have access to:

- Genomic testing
- Accurate biomarker interpretation
- FDA-approved or guideline-supported drugs
- Clinical trials when standard options are limited

If some populations are underrepresented in genomic datasets or have less access to testing and clinical trials, precision medicine may unintentionally increase existing health disparities. This project addresses fairness, access, health equity, and positive social impact by studying whether the evidence and opportunities behind targeted cancer treatment are distributed equitably.

## Social Justice Standards alignment

This project aligns most strongly with the **Justice** and **Action** standards, with support from **Identity** and **Diversity**.

- **Identity — Who is affected and why?** Lung adenocarcinoma patients are affected, especially patients whose communities may have less access to cancer specialists, genomic testing, targeted therapies, or clinical trials.
- **Diversity — How do different groups experience this issue differently?** Different groups may be represented differently in genomic datasets and may have different levels of access to biomarker testing and trials depending on geography, insurance, race/ethnicity, income, and health-care system resources.
- **Justice — What makes this problem unfair or inequitable?** Targeted therapy is only useful if patients can get tested and matched to treatment. If access is easier for patients near major cancer centers or for groups better represented in research datasets, then the benefits of precision medicine may not be shared fairly.
- **Action — How can this project contribute to meaningful change?** The project can identify where representation or access appears limited and recommend practical improvements, such as broader genomic testing access, more diverse clinical trial recruitment, clearer patient education, and more trial sites outside major academic centers.
...
To keep the project feasible in two weeks, focus on three biomarkers:

- **EGFR** — common actionable mutation in lung adenocarcinoma; important targeted therapy example
...
- Role in project: public research cohort for lung adenocarcinoma genomics and available clinical-demographic variables.
- Data to collect:
  - Total number of LUAD patients
...
- Number with ALK alterations
- Number with KRAS alterations
- Available demographic breakdowns, if easy to access
...
Use OncoKB to identify therapy evidence for EGFR, ALK, and KRAS in lung adenocarcinoma:

- Evidence level: Level 1 or Level 2
- Therapy name
- Alteration type
